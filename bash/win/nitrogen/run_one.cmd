...
REM Run one standard NitroGen solo benchmark config from the repo root.
REM Usage:
REM   bash\win\nitrogen\run_one.cmd obstacle_run_3d [extra run_benchmark args...]
...
:Usage
echo Usage:
echo   bash\win\nitrogen\run_one.cmd GAME [extra run_benchmark args...]
echo.
echo Games:
