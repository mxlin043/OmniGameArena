...
@REM shared_floor (coop) cold-start -- lcrt
@REM config: configs\vlm\cold_start\coop\shared_floor\vanilla_lcrt.yaml
...
@REM   topup = count existing finished matches and only run the missing ones
set "COUNT=fresh"
...
set "CONFIG=configs\vlm\cold_start\coop\%GAME%\vanilla_lcrt.yaml"
cd /d "%~dp0..\..\..\..\.."
