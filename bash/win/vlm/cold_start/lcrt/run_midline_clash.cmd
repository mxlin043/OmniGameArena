...
@REM midline_clash (pvp) cold-start -- lcrt
@REM config: configs\vlm\cold_start\pvp\midline_clash\vanilla_lcrt.yaml
...
set "OUTROOT=runs\lcrt"
set "CONFIG=configs\vlm\cold_start\pvp\%GAME%\vanilla_lcrt.yaml"
cd /d "%~dp0..\..\..\..\.."
