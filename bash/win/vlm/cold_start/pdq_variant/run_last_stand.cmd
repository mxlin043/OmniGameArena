...
@REM last_stand (solo) cold-start -- pdq_variant
@REM config: configs\vlm\cold_start\solo\last_stand\variant_pdq.yaml
...
set "CONFIG=configs\vlm\cold_start\solo\%GAME%\variant_pdq.yaml"
cd /d "%~dp0..\..\..\..\.."
