#!/usr/bin/env bash
# shared_floor (coop) cold-start -- pdq_variant
# config: configs/vlm/cold_start/coop/shared_floor/variant_pdq.yaml
...
CONFIG="configs/vlm/cold_start/coop/$GAME/variant_pdq.yaml"
