#!/usr/bin/env bash
# monster_shoot (solo) cold-start -- lcrt
# config: configs/vlm/cold_start/solo/monster_shoot/vanilla_lcrt.yaml
...
GAME=monster_shoot
OUTROOT=runs/lcrt
CONFIG="configs/vlm/cold_start/solo/$GAME/vanilla_lcrt.yaml"
